...
if _version_not_supported:
    raise RuntimeError(
        ...
        + " but the generated code in mod_pb2_grpc.py depends on"
...
def add_ModServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler("mod.ModService", rpc_method_handlers)
