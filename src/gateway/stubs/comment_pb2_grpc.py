...
if _version_not_supported:
    raise RuntimeError(
        ...
        + " but the generated code in comment_pb2_grpc.py depends on"
...
def add_CommentServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler("comment.CommentService", rpc_method_handlers)
